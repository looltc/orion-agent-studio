  ...
  return (
    <div className="p-6 max-w-5xl">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-semibold text-white">历史</h1>
          <p className="text-sm text-surface-500 mt-0.5">全部任务记录</p>
        </div>
